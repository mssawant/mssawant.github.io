---
layout: post
title: "The Life Cycle of a Token"
description: "From characters in an HTTP request body to bytes returned to a GPU page pool. KV cache sizing, paged attention, prefix caching and eviction, worked through Llama 3 8B."
image: /assets/token-lifecycle-diagram.png
date: 2026-09-24
---
...
<img src="/assets/token-lifecycle-diagram.png" style="max-width:100%; height:auto;"
     alt="The life cycle of a token: conception in the model checkpoint, birth at tokenization, circulation through the residual stream, persistence in the KV cache, output through the lm_head, and death by eviction from the page pool.">
...
<img src="/assets/stage0-vocabulary-diagram.png" style="max-width:100%; height:auto;"
     alt="How a token type is conceived: BPE merge learning produces a frozen vocabulary, and pretraining fills each embedding row with meaning.">
